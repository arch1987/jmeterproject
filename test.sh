...
./run.sh  -JTARGET_HOST=${TARGET_HOST} \ -JTARGET_PATH=${TARGET_HOST}${TARGET_PATH} \ -JTARGET_PATH=${TARGET_HOST}${TARGET_PATH1} \ -n -t ${T_DIR}/lifecharger_testplan.jmx -l ${T_DIR}/test-plan.jtl \ -e -o ${R_DIR}
